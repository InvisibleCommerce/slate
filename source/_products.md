...
```shell
curl "https://nexus.invisiblecommerce.com/api/v1/products" \
...
This endpoint retrieves all products. This endpoint supports [pagination](#pagination).
...
```shell
curl "https://nexus.invisiblecommerce.com/api/v1/products/34" \
  -H "Authorization: 1234567890987654321"
```
...
| ---- | ---------- | ----------- | -------- | ---- |
| id | path | ID of the requested product | Yes | integer |
